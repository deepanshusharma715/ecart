...
class Brand(models.Model):
    id=models.AutoField(primary_key=True)
    name=models.CharField(max_length=50)
    pic =models.ImageField(upload_to="brand",default=None,null=True,blank=True)
...
class Buyer(models.Model):
    ...
    otp=models.IntegerField(default=-12233424)
...
paymentMode=((1,"COD"),(1,"Net Banking"))
paymentStatus=((1,"Pending"),(2,"Done"))
orderStatus=((1,"Order Placed"),(2,"Ready to Dispatch"),(3,"Dispatched"),(4,"Out of Delivery"),(5,"Delivered"))
